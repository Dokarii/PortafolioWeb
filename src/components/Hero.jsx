    ...
    <section id="about" className="hero section container">
      <div className="hero-content">
        ...
        <p className="hero-description">
          Disfruto convertir problemas en soluciones, monotonía en innovación y
          líneas de código en utilidad. Programo lo que imagino y aporto valor
          con cada proyecto.
        </p>
        ...
        <div className="hero-cta">
          ...
          <a
            href="mailto:tejedoranayaricardo@gmail.com"
